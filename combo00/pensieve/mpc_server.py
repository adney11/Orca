...
#NN_MODEL = None
#NN_MODEL = '/newhome/orca_ood/pensieve/seperate_models/pensieve_fcc_linear.ckpt'
...
def main():
    if len(sys.argv) == 2:
        ...
        logging.basicConfig(filename=f'{script_dir}/../logs/{trace_file}-mpc_server.log', level=logging.DEBUG)
        global LOG, SUMMARY_DIR, LOG_FILE
