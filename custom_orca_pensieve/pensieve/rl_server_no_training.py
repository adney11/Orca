...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './custom_orca_pensieve/results'
LOG_FILE = './custom_orca_pensieve/results/log'
# in format of time_stamp bit_rate buffer_size rebuffer_time video_chunk_size download_time reward
# NN_MODEL = None
NN_MODEL = '/newhome/Orca/custom_orca_pensieve/pensieve/seperate_models/pensieve_fcc_linear.ckpt'
REWARD_TYPE = 'linear'
