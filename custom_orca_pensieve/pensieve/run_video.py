...
logging.basicConfig(filename=f'./custom_orca_pensieve/logs/orca_pensieve-{logfilename}-run_video.log', level=logging.DEBUG,format=FORMAT)
...
try:
	...
	default_chrome_user_dir = '/newhome/Orca/custom_orca_pensieve/pensieve/abr_browser_dir/chrome_data_dir'
	...
	rl_server_dir = "/newhome/Orca/custom_orca_pensieve/pensieve"
	...
	chrome_driver = '/newhome/Orca/custom_orca_pensieve/pensieve/abr_browser_dir/chromedriver'
