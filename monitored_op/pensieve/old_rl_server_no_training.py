...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './monitored_op/results'
LOG_FILE = './monitored_op/results/log'
# in format of time_stamp bit_rate buffer_size rebuffer_time video_chunk_size download_time reward
#NN_MODEL = None
#NN_MODEL = '/newhome/Orca/monitored_op/pensieve/seperate_models/pensieve_6mbps_random_increase_big0.ckpt'
#NN_MODEL = '/newhome/pensieve/rl_server/results/pretrain_linear_reward.ckpt'
NN_MODEL = '/newhome/Orca/monitored_op/pensieve/seperate_models/pensieve_3mbps_random_6mbps_max.ckpt'
# video chunk sizes
...
def main():
    if len(sys.argv) == 2:
        ...
        logging.basicConfig(filename=f'./monitored_op/logs/{logfilename}-rl_server_no_training.log', level=logging.DEBUG)
        global LOG
