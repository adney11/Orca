...
logging.basicConfig(filename=f'{dir}/logs/orca_ood-{logfilename}-run_video.log', level=logging.DEBUG,format=FORMAT)
...
try:
	...
	default_chrome_user_dir = f'{dir}/pensieve/abr_browser_dir/chrome_data_dir'
	...
	rl_server_dir = f"{dir}/pensieve"
	
	if abr_algo == 'RL':
		command = 'exec ' + python_binary + ' ' + rl_server_dir +'/rl_server_no_training.py ' + logfilename + ' ' + nn_model
	...
	chrome_driver = f'{dir}/pensieve/abr_browser_dir/chromedriver'
