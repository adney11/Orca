...
then
    ...
    dir="${cur_dir}/monitored_op"
    echo "[$0]: dir is: $dir"
    #exit
    orca_binary="orca-server-mahimahi-http-compmon"
    ...
    sudo killall -s9 orca-server-mahimahi-http-compmon
    ...
    then
        ...
        echo "you can run clean up now"
        for i in `seq 0 $((num_actors))`
        do
            sudo killall -s15 orca-server-mahimahi-http-compmon
