...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './pensieve_cwnd/results'
LOG_FILE = './pensieve_cwnd/results/log'
...
NN_MODEL = '/newhome/Orca/pensieve_cwnd/pensieve/seperate_models/pensieve_3mbps_random_6mbps_max.ckpt'
# video chunk sizes
...
def main():
    if len(sys.argv) == 2:
        ...
        logging.basicConfig(filename=f'./pensieve_cwnd/logs/pensieve_cwnd-{logfilename}-rl_server_no_training.log', level=logging.DEBUG)
        global LOG
