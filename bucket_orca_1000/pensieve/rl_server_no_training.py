...
def main():
    if len(sys.argv) == 3:
        ...
        logging.basicConfig(filename=f'{script_dir}/../logs/{logfilename}-rl_server_no_training.log', level=logging.DEBUG)
        ...
        pensieve_model_dir="/newhome/Orca/models/pensieve_models/"
        
        if nn_model != "None":
            NN_MODEL = f"{pensieve_model_dir}{nn_model}"
            LOG.info(f"Pensieve Model Set: {NN_MODEL}")
