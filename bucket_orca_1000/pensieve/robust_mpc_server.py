...
RANDOM_SEED = 42
RAND_RANGE = 1000
SUMMARY_DIR = './orca_ood/results'
LOG_FILE = './orca_ood/results/log'
# in format of time_stamp bit_rate buffer_size rebuffer_time video_chunk_size download_time reward
#NN_MODEL = None
NN_MODEL = '/newhome/orca_pensieve/pensieve/seperate_models/pensieve_fcc_linear.ckpt'
#REWARD_TYPE = 'linear'
...
def main():
    if len(sys.argv) == 2:
        ...
        logging.basicConfig(filename=f'{script_dir}/../logs/{trace_file}-robust_mpc_server.log', level=logging.DEBUG)
        global LOG, SUMMARY_DIR, LOG_FILE, NN_MODEL
        LOG = logging.getLogger(__name__)
        print('log file set')
        
        SUMMARY_DIR = f'{script_dir}/../results'
        LOG_FILE = f'{script_dir}/../results/log'
